                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a class="navbar-brand" href="CrearContacto.aspx"><span class="glyphicon glyphicon-user"></span> Obtener cuenta</a></li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="SesionContacto.aspx">Contacto</a></li>
                                    <li><a href="SesionAdmin.aspx">Administrador</a></li>
                                </ul>
                            </li>
